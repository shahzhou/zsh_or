...
// var zsh = '{"p":{"search":{"sq":[{"te":"nike","fi":"BRAND"}],"fq":[{"fi":"SOURCE","te":"USTM","co":"OR"}]}},"type":"brand","la":"en","qi":"2-Akyv09gXrmnZkKRq7NJCVUM/wEMneqzqXFeFZ6HnJds=","queue":1,"_":"9863"}'
// var zsh = 'ssssss';

// var z = LZString.compressToBase64(zsh);

function get_qz(key){
    var v = key;
    return LZString.compressToBase64(v)

}

// console.log(get_qz(zsh));